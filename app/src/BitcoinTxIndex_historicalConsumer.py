...
def HisticalTx(config, master="local[2]", appName="Historical Transaction", group_id='Alone-In-The-Dark', topicName='transaction', producer_host="localhost", producer_port='2181', db_host="db"): 
    ...
    dstream = KafkaUtils.createStream(ssc,config['zookeeper']['host']+':2181', group_id,{topicName:1},kafkaParams={"fetch.message.max.bytes":"1000000000"})\
